...
.. code-block:: shell
   ...
   % ipa-getcert request -d /etc/pki/tls/certs/nss -n 'Test' -K HTTP/np-ss01.angelsofclockwork.net -D np-ss01.angelsofclockwork.net
   ...
   Request ID '20190902000756':
           ...
           subject: CN=np-ss01.angelsofclockwork.net,O=ANGELSOFCLOCKWORK.NET
           expires: 2021-09-02 00:07:57 UTC
           dns: np-ss01.angelsofclockwork.net
           principal name: HTTP/np-ss01.angelsofclockwork.net@ANGELSOFCLOCKWORK.NET
           key usage: digitalSignature,nonRepudiation,keyEncipherment,dataEncipherment
           eku: id-kp-serverAuth,id-kp-clientAuth
           pre-save command:
           post-save command:
